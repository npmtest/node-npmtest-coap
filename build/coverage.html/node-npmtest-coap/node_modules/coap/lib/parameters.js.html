...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-coap/node_modules/coap/lib/parameters.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header medium">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-coap/node_modules/coap/lib/parameters.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-coap/node_modules/coap/lib/</a> &#187; parameters.js</div>
</div>
<div class="body">
...
<span class="cstat-no" title="statement not covered" >      p[key] = values[key]</span>
    }
  }
&nbsp;
...
&nbsp;
  ...
  <span class="missing-if-branch" title="if path not taken" >I</span>if (values &amp;&amp; (<span class="branch-1 cbranch-no" title="branch not covered" >typeof(values.pruneTimerPeriod)==="number")</span>) {
...
&nbsp;
&nbsp;
p.defaultTiming = <span class="fstat-no" title="function not covered" >function() {</span>
<span class="cstat-no" title="statement not covered" >  p.refreshTiming(defaultTiming)</span>
}
&nbsp;
module.exports = p
&nbsp;
